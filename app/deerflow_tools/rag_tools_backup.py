...
def rag_search_tool(
    ...
    Use this tool when the user asks questions about their favorited Bilibili videos,
    wants to find videos related to a specific topic, or needs to retrieve relevant
    video content from their personal collection.
